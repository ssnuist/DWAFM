...
def load_dataset_desc(dataset_name: str) -> str:
    ...
    """
    # D:/PYTHON_PROJECT/BasicTS - master/datasets/PEMS04
    # read json file: datasets/dataset_name/desc.json
    # print("11111")
    with open(f'D:/PYTHON_PROJECT/BasicTS-master/datasets/{dataset_name}/desc.json', 'r') as f:
        desc = json.load(f)
    return desc
...
def load_dataset_data(dataset_name: str) -> np.ndarray:
    ...
    dat_file_path = f'D:/PYTHON_PROJECT/BasicTS-master/datasets/{dataset_name}/data.dat'
