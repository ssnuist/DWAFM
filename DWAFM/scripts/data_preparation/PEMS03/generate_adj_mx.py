...
def generate_adj_pems03():
    distance_df_filename, num_of_vertices = "./DWAFM/datasets/raw_data/PEMS03/PEMS03.csv", 358
    ...
    with open("./DWAFM/datasets/raw_data/PEMS03/adj_PEMS03.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("./DWAFM/datasets/raw_data/PEMS03/adj_PEMS03_distance.pkl", "wb") as f:
