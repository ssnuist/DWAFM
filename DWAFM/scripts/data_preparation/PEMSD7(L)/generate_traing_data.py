...
data_file_path = f'./DWAFM/datasets/raw_data/{dataset_name}/{dataset_name}.npz'
graph_file_path = f'./DWAFM/datasets/raw_data/{dataset_name}/adj_{dataset_name}.pkl'
output_dir = f'./DWAFM/datasets/{dataset_name}'
