...
def generate_adj_pemsD7L():
    distance_df_filename, num_of_vertices = "./DWAFM/datasets/raw_data/PEMSD7(L)/PEMSD7(L).csv", 1026
    ...
    with open("./DWAFM/datasets/raw_data/PEMSD7(L)/adj_PEMSD7(L).pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("./DWAFM/datasets/raw_data/PEMSD7(L)/adj_PEMSD7(L)_distance.pkl", "wb") as f:
