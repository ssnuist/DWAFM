...
dataset_name = 'PEMS08'
data_file_path = f'./DWAFM/datasets/raw_data/{dataset_name}/{dataset_name}.npz' # your dir
graph_file_path = f'./datasets/raw_data/{dataset_name}/adj_{dataset_name}.pkl' # your dir
output_dir = f'./DWAFM/datasets/{dataset_name}'  # your dir
