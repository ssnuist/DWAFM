...
import pandas as pd
import numpy as np
from generate_adj_mx import generate_adj_pemsD7L as generate_adj

# Hyperparameters
dataset_name = 'PEMSD7(L)'
data_file_path = f'D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/{dataset_name}/{dataset_name}.npz'
graph_file_path = f'D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/{dataset_name}/adj_{dataset_name}.pkl'
output_dir = f'D:/PYTHON_PROJECT/BasicTS-master/datasets/{dataset_name}'
