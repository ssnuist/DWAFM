...
def generate_adj_pemsD7():
    distance_df_filename, num_of_vertices = "D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMSD7(M)/PEMSD7(M).csv", 228
    ...
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMSD7(M)/adj_PEMSD7(M).pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMSD7(M)/adj_PEMSD7(M)_distance.pkl", "wb") as f:
