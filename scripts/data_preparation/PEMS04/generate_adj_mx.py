...
def generate_adj_pems04():
    distance_df_filename, num_of_vertices = "./DWAFM/datasets/raw_data/PEMS04/PEMS04.csv", 307
    ...
    with open("./DWAFM/datasets/raw_data/PEMS04/adj_PEMS04.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("./DWAFM/datasets/raw_data/PEMS04/adj_PEMS04_distance.pkl", "wb") as f:
