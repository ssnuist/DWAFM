...
def generate_adj_pems04():
    distance_df_filename, num_of_vertices = "D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS04/PEMS04.csv", 307
    ...
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS04/adj_PEMS04.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS04/adj_PEMS04_distance.pkl", "wb") as f:
        pickle.dump(distance_mx, f)
    # with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/PEMS04/GFT_PEMS04.pkl", "wb") as f:
    #     pickle.dump(GFT, f)
generate_adj_pems04()