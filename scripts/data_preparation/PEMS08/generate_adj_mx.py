...
def generate_adj_pems08():
    distance_df_filename, num_of_vertices = "D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS08/PEMS08.csv", 170
    ...
    # print(adj_mx.shape)
    np.savez('D:/PYTHON_PROJECT/BasicTS-master/tests/adj.npz', data=adj_mx)
    print("Data saved as 'adj.npz'")
    # adj_mx30 = adj_mx[:30, :30]
    # plt.figure(figsize=(9, 6))  # 设置图形的大小
    # sns.heatmap(adj_mx30, cmap='YlGnBu', annot=True, fmt='.0f', linewidths=0.5, vmin=0, vmax=1)
    # plt.title("Heatmap of the First 30x30 Submatrix")
    # plt.show()
    ...
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS08/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("D:/PYTHON_PROJECT/BasicTS-master/datasets/raw_data/PEMS08/adj_PEMS08_distance.pkl", "wb") as f:
