...
def generate_adj_pems08():
    distance_df_filename, num_of_vertices = "./DWAFM/datasets/raw_data/PEMS08/PEMS08.csv", 170
    ...
    # print(adj_mx.shape)
    np.savez('./DWAFM/tests/adj.npz', data=adj_mx)
    ...
    with open("./DWAFM/datasets/raw_data/PEMS08/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(",/DWAFM/datasets/raw_data/PEMS08/adj_PEMS08_distance.pkl", "wb") as f:
